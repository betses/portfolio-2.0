...
export default function Navigation() {
  return (
    <div className="justify-between hidden w-full gap-4 p-6 mb-5 bg-white lg:flex rounded-3xl">
      ...
      <NavLink to="/Blogs" className="flex flex-col items-center bg-[#f3f6f6] p-5 rounded-xl hover:bg-gradient-to-r from-[#fa5252] to-[#e32e6e] hover:text-white ease-in duration-200">
        <span className="text-xl">
          <svg
            stroke="currentColor"
            fill="currentColor"
      ...
      <NavLink to="/" className="flex flex-col items-center bg-[#f3f6f6] px-2 py-5 rounded-xl hover:bg-gradient-to-r from-[#fa5252] to-[#e32e6e] hover:text-white ease-in duration-200">
        <span className="text-xl">
          <svg
            stroke="currentColor"
            fill="currentColor"
